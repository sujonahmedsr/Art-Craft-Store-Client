        ...
        <div className="py-20">
            <div className="w-full max-w-md container mx-auto p-8 space-y-3 rounded-xl text-gray-900 bg-gray-100 shadow-2xl">
                ...
                <form onSubmit={handleSignInMethod} className="space-y-6">
                    ...
                    <button className="block w-full p-3 text-center rounded-sm text-white bg-green-600">Sign in</button>
                </form>
                ...
                <p className="text-xs text-center sm:px-6 text-gray-400">Dont have an account?
                    <Link to={'/signUp'} className="underline text-green-600">Sign up</Link>
                </p>
            </div>
        </div>
    );
