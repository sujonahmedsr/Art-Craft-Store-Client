            ...
            <footer className="py-6 border-t-2">
                <div className="container px-6 mx-auto space-y-6 divide-y dark:divide-gray-600 md:space-y-12 divide-opacity-50">
                    <div className="grid grid-cols-12 gap-6">
                        <div className="pb-6 col-span-6 md:pb-0 md:col-span-4 gap-5">
                            <Link to={'/'}>
                        ...
                        <form className="col-span-12 md:col-span-4 space-y-3 p-5 border rounded-xl">
                            <div className="col-span-full sm:col-span-3 space-y-2">
                                <label htmlFor="lastname" className="text-base">Full name</label>
                                <input id="lastname" type="text" placeholder="Full name" className="w-full rounded-md  py-2 px-2 border" />
                            </div>
                            <div className="col-span-full sm:col-span-3 space-y-2">
                                <label htmlFor="email" className="text-base">Email</label>
                                <input id="email" type="email" placeholder="Email" className="w-full rounded-md py-2 px-2 border" />
                            </div>

                            <div className="col-span-full space-y-2">
                                <label htmlFor="bio" className="text-base">Bio</label>
                                <textarea id="bio" placeholder="Message Us" className="w-full rounded-md py-2 px-2 border"></textarea>
                            </div>
                            <button className="px-8 py-3 bg-green-600 text-white font-semibold rounded-xl w-full">Send Message</button>
                        </form>
                    </div>
