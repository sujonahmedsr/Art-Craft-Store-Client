    ...
    return (
        <div className="container mx-auto py-28 px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {
                    results.map(art => <div key={art._id}>
                        <div className="bg-slate-50 text-slate-900 p-5 rounded-xl shadow-2xl border hover:border-green-500 duration-300 transition ">
                            ...
                            <div className="flex items-center justify-between gap-6 py-5">
                                <Link className="font-bold bg-green-600 text-white px-6 py-3 rounded hover:bg-green-700">Update</Link>
                                <Link onClick={deleteButton} className="font-bold bg-green-600 text-white px-6 py-3 rounded hover:bg-green-700">Delete</Link>
                            </div>
                        </div>
                    </div>)
                }
